...
public class ConfiguredPlacedFeatures {
    ...
    private static final List<OreConfiguration.TargetBlockState> UNSTABLE_SULFURIC_ORE_TARGETS = listizeStoneVarientedOre(ModBlocks.UNSTABLE_SULFURIC_ORE);
    ...
    public static final BundledConfiguredPlacedFeature UNSTABLE_SULFURIC_ORE = new BundledConfiguredPlacedFeature(WorldGenConfig.UNSTABLE_SULFURIC_ORE_CONFIG, UNSTABLE_SULFURIC_ORE_TARGETS);
